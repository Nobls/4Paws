                        ...
                        <div className={s.wrapperInformationBlock}>
                            ...
                            <div className={s.linkWrapper}>
                                ...
                                <Link className={s.link} to={"/"}>
                                    ...
                                    <svg className={s.icon} id="Icons" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <g id="Instagram">
                                            ...
                                            <path id="Instagram-2" className="cls-1"
                                ...
                                <Link className={s.link} to={"/"}>
                                    ...
                                    <svg className={s.icon} id="Icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 215 215" fill={"#ffffff"}>
                                        <g id="Telegram">
                                            ...
                                            <path id="Telegram-2" className="cls-2"
                                ...
                                <Link className={s.link} to={"/"}>
                                    ...
                                    <svg className={s.icon} id="Icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 215 215"
                                         fill="#ffffff">
                                        <g id="Viber">
                                            <path id="Background"
                                            ...
                                            <g id="Viber-2">
                                                ...
                                                <path id="Viber-3" className="cls-1"
                                                      ...
                                                      transform="translate(0 -277)" fill={"#eb5837"}/>
                                                <path id="Viber-4" className="cls-1"
                                                      ...
                                                      transform="translate(0 -277)" fill={"#eb5837"}/>
                                                <path id="Viber-5" className="cls-1"
                                                      ...
                                                      transform="translate(0 -277)" fill={"#eb5837"}/>
                                                <path id="Viber-6" className="cls-1"
