                        ...
                        <div className={s.wrapperSocials}>
                            <Link to={"/"}>
                                <svg id="Icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 215 215" fill="#eb5837">
                                    ...
                                    <path id="Instagram-2" className={s.iconInner} fill="#fff"
                            ...
                            <Link to={"/"}>
                                <svg id="Icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 215 215" fill="#eb5837">
                                    <circle id="Background" cx="107.5" cy="107.5" r="107.5"/>
                                    <path className={s.iconInner} fill="#fff"
                                    ...
                                    <path id="Viber-3" className={s.iconInner} fill="#fff"
                                          ...
                                          transform="translate(0 -277)"/>
                                    <path id="Viber-4" className={s.iconInner} fill="#fff"
                                          ...
                                          transform="translate(0 -277)"/>
                                    <path id="Viber-5" className={s.iconInner} fill="#fff"
                                          ...
                                          transform="translate(0 -277)"/>
                                    <path id="Viber-6" className={s.iconInner} fill="#fff"
                            ...
                            <Link to={"/"}>
                                <svg id="Icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 215 215" fill="#eb5837">
                                    <circle id="Background" cx="107.5" cy="107.5" r="107.5"/>
                                    <path id="Telegram-2" className={s.iconInner} fill="#fff"
                            ...
                            <Link to={"/"}>
                                <svg id="Icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 215 215" fill="#eb5837">
                                    <circle id="Background" cx="107.5" cy="107.5" r="107.5"/>
                                    <path id="VK-2" className={s.iconInner} fill="#fff"
